...
class StoryBrain {
  //creating the property name storyNumber..
  int _storyNumber = 0;
  // Story story = Story(_storyTitle, _choice1, _choice2)
...
// if choiceNumber was equal to 1 and the storyNumber is 0, the storyNumber should become 2.
    if (choiceNumber == 1 && this._storyNumber == 0) {
      ...
      this._storyNumber = 2;
      print("the story index${this._storyNumber}");
...
// which checks to see if storyNumber is 0 or 1 or 2 (when both buttons
// should show choices) and return true if that is the case, else it should return false.
...
//: Step 25 - Change the storyNumber property into a private property so that only StoryBrain.dart has access to it. You can do this by right clicking on the name (storyNumber) and selecting Refactor -> Rename to make the change across all the places where it's used.
